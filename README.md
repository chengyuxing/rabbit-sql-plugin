...
IDEA 2023.1.* - 2024.3.* is required.
...
1. Add dependency **Rabbit-sql 7.12.6+** to your project;
...
1. Add dependency **rabbit-sql-spring-boot-starter 2.11.6+** to your project;
2. Create `xql-file-manager.yml` in source root: `.../src/main/resources/`;
3. Register your xql files on property: `files`;
