...
1. Add dependency **rabbit-sql 9.0.1+(jdk17+) or 8.1.3+(jdk8)** to your project;
...
1. Add dependency **rabbit-sql-spring-boot-starter 4.0.0+(jdk17+) or 3.1.3+(jdk8)** to your project;
2. Create `xql-file-manager.yml` in source root: `.../src/main/resources/`;
3. Register your xql files on property: `files`;
