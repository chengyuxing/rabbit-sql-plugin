...
IDEA 2020.3.* - 2026.2.* is required.
...
1. Add dependency **rabbit-sql 10.3.12+** to your project;
...
1. Add dependency **rabbit-sql-spring-boot-starter 5.3.12+** to your project;
2. Create `xql-file-manager.yml` in source root: `.../src/main/resources/`;
3. Register your xql files on property: `files`;
