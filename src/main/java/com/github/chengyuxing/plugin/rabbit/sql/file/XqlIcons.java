...
public class XqlIcons {
    ...
    public static final Icon XQL_ITEM = IconLoader.getIcon("icons/xql-item.svg", XqlIcons.class);
    ...
    public static final Icon XQL_FILE_MANAGER_TOOL_WINDOW = IconLoader.getIcon("icons/xql-file-manager-tool-window.svg", XqlIcons.class);
}
