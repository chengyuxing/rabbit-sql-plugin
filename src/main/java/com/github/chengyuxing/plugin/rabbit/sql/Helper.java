...
public class Helper extends WebHelpProvider {
    ...
    public @Nullable String getHelpPageUrl(@NotNull String helpTopicId) {
        switch (helpTopicId) {
            case XQL_FILE_MANAGER:
                return "https://github.com/chengyuxing/rabbit-sql?tab=readme-ov-file#xqlfilemanager";
            case XQL_FILE_MANAGER_BAKI_DAO:
                return "https://github.com/chengyuxing/rabbit-sql?tab=readme-ov-file#autoxfmconfig";
            case SPRING_INTERFACE_MAPPER_USAGE:
                return "https://github.com/chengyuxing/rabbit-sql-spring-boot-starter?tab=readme-ov-file#simple-usage";
            default:
                return null;
        }
    }
