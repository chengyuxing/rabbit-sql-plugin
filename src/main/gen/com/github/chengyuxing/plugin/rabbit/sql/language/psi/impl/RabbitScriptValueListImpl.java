...
public class RabbitScriptValueListImpl extends ASTWrapperPsiElement implements RabbitScriptValueList {

  public RabbitScriptValueListImpl(@NotNull ASTNode node) {
    super(node);
  }
