...
public class RabbitScriptFiTailImpl extends ASTWrapperPsiElement implements RabbitScriptFiTail {

  public RabbitScriptFiTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RabbitScriptVisitor visitor) {
    visitor.visitFiTail(this);
  }
