...
public class RabbitScriptForOptsImpl extends ASTWrapperPsiElement implements RabbitScriptForOpts {

  public RabbitScriptForOptsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RabbitScriptVisitor visitor) {
    visitor.visitForOpts(this);
  }
