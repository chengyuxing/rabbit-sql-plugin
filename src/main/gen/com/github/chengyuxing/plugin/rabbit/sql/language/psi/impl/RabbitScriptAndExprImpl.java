...
public class RabbitScriptAndExprImpl extends ASTWrapperPsiElement implements RabbitScriptAndExpr {

  public RabbitScriptAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RabbitScriptRelExpr> getRelExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RabbitScriptRelExpr.class);
  }
