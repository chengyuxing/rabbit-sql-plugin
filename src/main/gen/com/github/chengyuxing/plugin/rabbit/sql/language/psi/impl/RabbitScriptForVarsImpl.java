...
public class RabbitScriptForVarsImpl extends ASTWrapperPsiElement implements RabbitScriptForVars {

  public RabbitScriptForVarsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RabbitScriptVisitor visitor) {
    visitor.visitForVars(this);
  }
