...
public class RabbitScriptRelExprImpl extends ASTWrapperPsiElement implements RabbitScriptRelExpr {

  public RabbitScriptRelExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public RabbitScriptCompareExpr getCompareExpr() {
    return findChildByClass(RabbitScriptCompareExpr.class);
  }

  @Override
  @Nullable
  public RabbitScriptParenExpr getParenExpr() {
    return findChildByClass(RabbitScriptParenExpr.class);
  }
