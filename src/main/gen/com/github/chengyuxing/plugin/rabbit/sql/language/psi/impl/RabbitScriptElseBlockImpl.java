...
public class RabbitScriptElseBlockImpl extends ASTWrapperPsiElement implements RabbitScriptElseBlock {

  public RabbitScriptElseBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
