...
public class RabbitScriptValPipeOptImpl extends ASTWrapperPsiElement implements RabbitScriptValPipeOpt {

  public RabbitScriptValPipeOptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RabbitScriptVisitor visitor) {
    visitor.visitValPipeOpt(this);
  }
