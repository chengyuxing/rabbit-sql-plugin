...
public class RabbitScriptExprImpl extends ASTWrapperPsiElement implements RabbitScriptExpr {

  public RabbitScriptExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public RabbitScriptOrExpr getOrExpr() {
    return findNotNullChildByClass(RabbitScriptOrExpr.class);
  }
