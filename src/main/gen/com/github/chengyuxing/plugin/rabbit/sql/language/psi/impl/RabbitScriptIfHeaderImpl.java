...
public class RabbitScriptIfHeaderImpl extends ASTWrapperPsiElement implements RabbitScriptIfHeader {

  public RabbitScriptIfHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RabbitScriptVisitor visitor) {
    visitor.visitIfHeader(this);
  }
  ...
  @Override
  @NotNull
  public RabbitScriptExpr getExpr() {
    return findNotNullChildByClass(RabbitScriptExpr.class);
  }
