...
public class RabbitScriptForStmtImpl extends ASTWrapperPsiElement implements RabbitScriptForStmt {

  public RabbitScriptForStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public RabbitScriptForOpts getForOpts() {
    return findChildByClass(RabbitScriptForOpts.class);
  }
  ...
  @Override
  @NotNull
  public RabbitScriptForVars getForVars() {
    return findNotNullChildByClass(RabbitScriptForVars.class);
  }
