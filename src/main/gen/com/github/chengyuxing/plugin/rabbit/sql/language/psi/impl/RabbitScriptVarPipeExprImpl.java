...
public class RabbitScriptVarPipeExprImpl extends ASTWrapperPsiElement implements RabbitScriptVarPipeExpr {

  public RabbitScriptVarPipeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RabbitScriptVisitor visitor) {
    visitor.visitVarPipeExpr(this);
  }
