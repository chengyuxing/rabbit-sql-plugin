...
public class RabbitScriptWhenBlockImpl extends ASTWrapperPsiElement implements RabbitScriptWhenBlock {

  public RabbitScriptWhenBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
