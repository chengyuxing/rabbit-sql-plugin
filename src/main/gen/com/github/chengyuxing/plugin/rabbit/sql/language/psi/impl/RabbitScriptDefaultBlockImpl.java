...
public class RabbitScriptDefaultBlockImpl extends ASTWrapperPsiElement implements RabbitScriptDefaultBlock {

  public RabbitScriptDefaultBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
