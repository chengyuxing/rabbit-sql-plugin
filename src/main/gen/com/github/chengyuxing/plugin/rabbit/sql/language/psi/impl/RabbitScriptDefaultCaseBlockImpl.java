...
public class RabbitScriptDefaultCaseBlockImpl extends ASTWrapperPsiElement implements RabbitScriptDefaultCaseBlock {

  public RabbitScriptDefaultCaseBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RabbitScriptVisitor visitor) {
    visitor.visitDefaultCaseBlock(this);
  }
